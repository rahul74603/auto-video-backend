...
// --- REUSABLE CARD COMPONENT (Declared outside render to keep state stable) ---
type UpdateCardColor = {
  border: string;
  bg: string;
  text: string;
};
...
const UpdateCard = ({ title, color, items, icon: Icon }: UpdateCardProps) => (  <div className={`border-2 ${color.border} rounded-xl overflow-hidden shadow-md bg-white h-full flex flex-col`}>
