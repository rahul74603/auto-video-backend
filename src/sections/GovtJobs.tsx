...
// Apply Now button listing se hataya — user pehle DETAILS padhe (engagement + detail page views).
// applyLink ab sirf detail page se open hota hai (JobDetails me handled).
