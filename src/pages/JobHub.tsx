...
const JobHub = () => {
    ...
    if (!hub) return <Navigate to="/govt-jobs" replace />;
                    ...
                    <div className="lg:col-span-2 space-y-3 md:space-y-4">
                        {loading ? (
                            ...
                            <div className="bg-white rounded-2xl p-10 text-center border border-slate-100">
                                ...
                                <Link to="/govt-jobs" className="inline-flex items-center gap-1 mt-3 text-blue-600 font-black text-sm hover:underline">
                        ...
                        {expired.length > 0 && (
                            <div className="pt-3">
                                ...
                                {expired.map((job) => (
                                    <Link key={job.id} to={`/job/${job.slug}`} className="block py-2 px-3 rounded-xl hover:bg-white text-[11px] md:text-xs font-bold text-slate-400 line-through decoration-slate-300">
                                        {job.title}
                                    </Link>
                                ))}
                            </div>
