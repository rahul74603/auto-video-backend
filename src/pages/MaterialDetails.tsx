...
const MaterialDetails = () => {
  ...
  if (!item) return (
    <div className="pt-24 md:pt-40 text-center px-4 font-hindi">
      ...
      <Button onClick={() => navigate(ROUTES.studyMaterial)} className="bg-blue-600 text-white font-black px-8 py-4 rounded-xl shadow-lg h-auto">वापस लाइब्रेरी जाएं</Button>
    </div>
  );
  ...
  return (
    <div className="pt-16 md:pt-20 pb-16 md:pb-24 bg-[#F8FAFC] min-h-screen font-hindi antialiased">
      ...
      <div className="max-w-7xl mx-auto px-2 md:px-8">
        ...
        <button onClick={() => navigate(ROUTES.studyMaterial)} className="flex items-center gap-1.5 text-slate-500 hover:text-blue-600 font-black mb-4 transition-all text-[11px] md:text-base bg-white px-3 py-1.5 rounded-full shadow-sm border border-slate-100">
...
{/* ✅ SEO FIX: Internal Links Section (Fixes 'No outgoing links' and 'Orphan page' error) */}
          ...
          <aside className="w-[40%] md:w-[32%] space-y-3 md:space-y-6 sticky top-12 md:top-16">
            ...
            <div className="p-3 md:p-6 bg-gradient-to-br from-indigo-700 via-blue-800 to-slate-900 rounded-xl md:rounded-[2.5rem] text-white shadow-2xl relative overflow-hidden group">
                ...
                <button onClick={() => navigate(ROUTES.premiumNotes)} className="w-full bg-yellow-400 text-blue-900 font-black py-2 md:py-4 rounded-xl text-[9px] md:text-sm hover:bg-white transition-all shadow-xl"> अभी पाएँ ➔ </button>
            </div>
